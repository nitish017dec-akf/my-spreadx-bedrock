...
# Extraction max tokens (Bedrock limits to 4096 for standard Claude 3 models)
TEXT_EXTRACT_MAX_TOKENS = 4096     # Claude output ceiling for text extraction
VISION_EXTRACT_MAX_TOKENS = 4096   # Claude output ceiling for vision extraction
